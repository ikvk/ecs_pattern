...
* `Snow day scene: pygame + ecs_pattern <https://github.com/ikvk/ecs_pattern/tree/master/examples/snow_day>`_.
* `Trig fall: pygame + ecs_pattern + numpy <https://github.com/ikvk/ecs_pattern/tree/master/examples/trig>`_.
