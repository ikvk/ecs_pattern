...
from player.entities import PlayerData
from player.systems import SysControl, SysDraw, SysInit


def player_loop(display: Surface, clock: Clock):
    """Основной цикл плеера"""
    ...
    player_data: PlayerData = next(entities.get_by_class(PlayerData))

    while player_data.do_play:
