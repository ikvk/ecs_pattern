Advanced GUI with ecs_pattern
========================================================================================================================

This is working GUI demo form my one real project.

Run it by: `gui/demo.py <https://github.com/ikvk/ecs_pattern/tree/master/examples/gui/demo.py>`_
...
\* Link to the project:
    https://www.rustore.ru/catalog/app/ru.ikvk.diafilms_offline
